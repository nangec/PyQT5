...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line.setGeometry(QtCore.QRect(80, 160, 118, 3))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.calendarWidget = QtWidgets.QCalendarWidget(self.centralwidget)
        self.calendarWidget.setGeometry(QtCore.QRect(110, 370, 200, 137))
        self.calendarWidget.setObjectName("calendarWidget")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(40, 209, 421, 71))
        ...
        self.widget.setGeometry(QtCore.QRect(60, 70, 298, 71))
